...
\begin{enumerate}
    ...
    Empresas como \textit{Philips} o \textit{Google} ya mencionadas invierten una gran parte de su presupuesto en equipos de abogados del mas alto nivel. Por lo que el uso de código ilegal/copiado extraído directamente de la inteligencia artificial, podría acarrear demandas o multas imposibles de asumir por parte de los desarrolladores de este proyecto.
...
La integración de la Inteligencia Artificial en el desarrollo de software clínico representa una herramienta de doble filo. Por un lado, su principal fortaleza radica en su papel como un excelente asistente tecnológico, capaz de agilizar la implementación de nuevas funcionalidades, resolver bloqueos técnicos y ofrecer propuestas de código cada vez más rigurosas que aceleran el ciclo de desarrollo. Por otro lado, su uso indiscriminado o a ciegas conlleva riesgos inasumibles en un entorno tan crítico como el hospitalario.
