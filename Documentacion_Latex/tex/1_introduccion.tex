...
Cabe señalar que la numeración total alcanza las 56 páginas. Sin embargo, 5 de ellas corresponden a separadores de sección u hojas en blanco introducidas para facilitar la legibilidad del lector. Por tanto, la extensión real de contenido técnico se sitúa en 51 páginas, habiéndose realizado un importante esfuerzo de síntesis para ajustarse lo máximo posible al límite de 50 páginas sin comprometer la claridad de la exposición.
